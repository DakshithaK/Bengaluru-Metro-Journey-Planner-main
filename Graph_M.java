...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Bangalore Metro Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Calculate fare based on Bangalore Metro fare structure
		...
		public static void Create_Metro_Map(Graph_M g)
		{
			...
			g.addVertex("Krishnarajapura~P");
			g.addVertex("Baiyappanahalli~P");
			g.addVertex("Indiranagar~P");
			g.addVertex("MG Road~PG");
			g.addVertex("Vidhana Soudha~P");
			g.addVertex("Kuvempu Road~P");
			g.addVertex("Rajajinagar~P");
			g.addVertex("Vijayanagar~P");
			g.addVertex("Challaghatta~P");
			
			// Green Line stations
			g.addVertex("Madavara~G");
			g.addVertex("Nagasandra~G");
			g.addVertex("Mantri Square Sampige Road~G");
			g.addVertex("Majestic~PG");
			...
			g.addVertex("Rashtreeya Vidyalaya Road~Y");
			g.addVertex("Yeshwantpur~Y");
			g.addVertex("Bommasandra~Y");
			
			// Purple Line connections
			g.addEdge("Whitefield~P", "Krishnarajapura~P", 8);
			g.addEdge("Krishnarajapura~P", "Baiyappanahalli~P", 6);
			g.addEdge("Baiyappanahalli~P", "Indiranagar~P", 5);
			g.addEdge("Indiranagar~P", "MG Road~PG", 4);
			g.addEdge("MG Road~PG", "Vidhana Soudha~P", 3);
			g.addEdge("Vidhana Soudha~P", "Kuvempu Road~P", 4);
			g.addEdge("Kuvempu Road~P", "Rajajinagar~P", 5);
			g.addEdge("Rajajinagar~P", "Vijayanagar~P", 6);
			g.addEdge("Vijayanagar~P", "Challaghatta~P", 7);
			
			// Green Line connections
			g.addEdge("Madavara~G", "Nagasandra~G", 6);
			g.addEdge("Nagasandra~G", "Mantri Square Sampige Road~G", 5);
			g.addEdge("Mantri Square Sampige Road~G", "Majestic~PG", 4);
			g.addEdge("Majestic~PG", "National College~G", 3);
			g.addEdge("National College~G", "Lalbagh~G", 4);
			g.addEdge("Lalbagh~G", "Banashankari~G", 5);
			g.addEdge("Banashankari~G", "Silk Institute~G", 6);
			
			// Interchange connections (MG Road and Majestic)
			g.addEdge("MG Road~PG", "Majestic~PG", 4);
			
			// Yellow Line connections
			g.addEdge("Rashtreeya Vidyalaya Road~Y", "Yeshwantpur~Y", 5);
			g.addEdge("Yeshwantpur~Y", "Bommasandra~Y", 8);
			g.addEdge("Yeshwantpur~Y", "Mantri Square Sampige Road~G", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			while(true)
			{
				...
				else
				{
					...
					System.out.println("SHORTEST DISTANCE FROM "+st1+" TO "+st2+" IS "+distance+" KM");
				...
				case 5:
					...
					else 
					{
						...
						int len = str.size();
						int distance = Integer.parseInt(str.get(len-1));
						int fare = g.calculateFare(distance);
